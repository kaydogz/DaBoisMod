...
public class DBMEffects {
	...
	public static final RegistryObject<IndicaStonageEffect> INDICA_STONAGE = EFFECTS.register("indica_stonage", () -> (IndicaStonageEffect) new IndicaStonageEffect(EffectType.BENEFICIAL, 2523174).addAttributesModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "7398DB42-6B24-4117-945D-14BA1BFF8008", (double) 0.2F, AttributeModifier.Operation.MULTIPLY_TOTAL));
