...
public class DBMEditSignScreen extends Screen {
    ...
    private final DBMSignTileEntityRenderer.DBMSignModel signModel = new DBMSignTileEntityRenderer.DBMSignModel();
    /** Reference to the sign object. */
    public final SignTileEntity tileSign;
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        RenderMaterial rendermaterial = DBMSignTileEntityRenderer.getDBMMaterial(blockstate.getBlock());
