	...
	public static void registerCommand(final CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register(Commands.literal("quest")
				...
				.then(Commands.literal("clear")
						.executes(context -> QuestCommand.clearQuests(context.getSource(), Collections.singleton(context.getSource().asPlayer())))
						.then(Commands.argument("targets", EntityArgument.players())
								.executes(context -> QuestCommand.clearQuests(context.getSource(), EntityArgument.getPlayers(context, "targets"))))));
	}
