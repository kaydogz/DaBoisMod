...
public class PadaukTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
	
	public PadaukTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> function) {
		super(function);
	}
			...
			if (direction1 != direction) {
				...
				for(int l2 = j3; l2 < i && k2 > 0; --k2) {
					if (l2 >= 1) {
						...
						if (this.setLog(generationReader, rand, blockpos$mutable.setPos(j1, i3, k1), p_225557_4_, boundingBoxIn, configIn)) {
							l1 = i3;
						}
					}
