...
import com.github.kaydogz.daboismod.network.server.SUpdateDimensionPacket;
...
/**
 * Copied and updated from Hyperbox
  */
public class DimensionHelper {
    ...
    private static ServerWorld createAndRegisterWorldAndDimension(MinecraftServer server, Map<RegistryKey<World>, ServerWorld> map, RegistryKey<World> worldKey, BiFunction<MinecraftServer, RegistryKey<Dimension>, Dimension> dimensionFactory) {
        ...
        SaveFormat.LevelSave levelSave = server.anvilConverterForAnvilFile;
        ...
        DBMNetworkHandler.sendToAll(new SUpdateDimensionPacket(worldKey, true));
