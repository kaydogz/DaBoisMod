...
public class CannabisBlock extends Block implements IPlantable {
	...
	public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
		...
		if (blockstate.getBlock() == this) {
			...
			if (blockstate.isIn(Blocks.GRASS_BLOCK) || blockstate.isIn(Blocks.DIRT) || blockstate.isIn(Blocks.COARSE_DIRT) || blockstate.isIn(Blocks.PODZOL) || blockstate.isIn(Blocks.SAND) || blockstate.isIn(Blocks.RED_SAND) || blockstate.isIn(DBMBlocks.BOTSWANIAN_GRASS_BLOCK.get()) || blockstate.isIn(DBMBlocks.BOTSWANIAN_DIRT.get())) {
