...
public class DBMBlocks {
	...
	public static final RegistryObject<LogBlock> PADAUK_LOG = BLOCKS.register("padauk_log", () -> new LogBlock(MaterialColor.RED, Block.Properties.create(Material.WOOD, MaterialColor.RED).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<LogBlock> STRIPPED_PADAUK_LOG = BLOCKS.register("stripped_padauk_log", () -> new LogBlock(MaterialColor.RED, Block.Properties.create(Material.WOOD, MaterialColor.RED).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<RotatedPillarBlock> PADAUK_WOOD = BLOCKS.register("padauk_wood", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.RED).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
